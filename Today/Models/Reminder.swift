...
/*
Флаг #if DEBUG - это директива компиляции, которая предотвращает компиляцию вложенного кода при создании приложения для выпуска. Вы можете использовать этот флаг для тестирования кода в отладочных сборках или для предоставления образцов тестовых данных, как вы сделаете на следующем шаге.
 */
#if DEBUG
extension Reminder {
